...
# install seqan
ADD http://packages.seqan.de/seqan-library/seqan-library-2.4.0.tar.xz seqan-library-2.4.0

RUN cp -r seqan-library-2.4.0/include seqan-library-2.4.0/share /usr/local/
...
# install art
ADD https://www.niehs.nih.gov/research/resources/assets/docs/artbinmountrainier20160605linux64tgz.tgz artbinmountrainier20160605linux64tgz
RUN cp art_bin_MountRainier/art_illumina /usr/bin
